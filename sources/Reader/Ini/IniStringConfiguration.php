...
/**
 * Configuration for ini content.
 */
class IniStringConfiguration implements ConfigurationInterface
{
    ...
    {
        // try/catch because if non-valid ini data is passed to parse_ini_string
